/* BFS Traversal -- Undirected Graph */
...
void bfsTraversal()  // All vertices can be reachable in undirected graph from any starting vertex
{
    int u, v;
    char s[50];
...
void bfs(int v)  // Represents only those vertices that are reachable from starting vertex
{
    int i;
    initialization();
    enqueue(v);
